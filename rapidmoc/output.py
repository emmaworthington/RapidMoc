...
def create_netcdf(config, rapid_trans, model_trans, fc_trans,
    ...
    mocmax_rapid = dataset.createVariable(
        'mocmax_rapid', np.float64, (tdim.name))
    ...
    mocmax_model = dataset.createVariable(
        'mocmax_model', np.float64, (tdim.name))
    ...
    sf_rapid = dataset.createVariable(
        'sf_rapid', np.float64, (tdim.name, zdim.name))
    sf_rapid.units = 'Sv'
    ...
    q_gyre_rapid = dataset.createVariable(
        'q_gyre_rapid', np.float64, (tdim.name))
    ...
    q_net_rapid = dataset.createVariable(
        'q_net_rapid', np.float64, (tdim.name))
    ...
    q_sum_model = dataset.createVariable(
        'q_sum_model', np.float64, (tdim.name))
    ...
    q_gyre_model = dataset.createVariable(
        'q_gyre_model', np.float64, (tdim.name))
    ...
    fw_sum_rapid = dataset.createVariable(
        'fw_sum_rapid', np.float64, (tdim.name))
    ...
    fw_gyre_rapid = dataset.createVariable(
        'fw_gyre_rapid', np.float64, (tdim.name))
    ...
    fw_ot_rapid = dataset.createVariable(
        'fw_ot_rapid', np.float64, (tdim.name))
    ...
    fw_net_rapid = dataset.createVariable(
        'fw_net_rapid', np.float64, (tdim.name))
    ...
    fw_sum_model = dataset.createVariable(
        'fw_sum_model', np.float64, (tdim.name))
    ...
    fw_gyre_model = dataset.createVariable(
        'fw_gyre_model', np.float64, (tdim.name))
    ...
    fw_ot_model = dataset.createVariable(
        'fw_ot_model', np.float64, (tdim.name))
    ...
    fw_net_model = dataset.createVariable(
        'fw_net_model', np.float64, (tdim.name))
